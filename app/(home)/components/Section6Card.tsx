...
const Card = "/img/photos/photo_5.png";

export default function Section6Card() {
    ...
    const rotateZ = useTransform(scrollYProgress, [0, 1], [-20, 0]); // 0° a 15°
    const rotateX = useTransform(scrollYProgress, [0, 1], [-15, 30]); // 0° a 15°
