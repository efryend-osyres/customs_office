...
const Card = "/img/photos/photo_4.png";
...
export default function Section5Card() {
    ...
    const rotateZ = useTransform(scrollYProgress, [1, 0], [-0, -15]); // 0° a 15°
    const rotateX = useTransform(scrollYProgress, [1, 0], [-30, -15]); // 0° a 15°
